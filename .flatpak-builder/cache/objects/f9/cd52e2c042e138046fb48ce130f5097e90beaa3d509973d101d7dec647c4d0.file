...
public:
   ...
   * this widget.
   * 
   * @return The entry buffer object.
   */
   ...
   * this widget.
   * 
   * @param buffer An entry buffer object.
   */
   ...
   * 
   * @param visible True if the contents of the text widget are displayed
   * as plain text.
   */
   ...
   * 
   * @return Whether text is overwritten when typing.
   */
   ...
   * 
   * @param max The maximum length of the text, or 0 for no maximum.
   ...
   * 
   * @return The maximum allowed number of characters, or 0 if
   * there is no limit.
   */
   ...
   * 
   * @return The length of the contents, in characters.
   */
   ...
   * the default widget.
   * 
   * This usually means that the dialog containing @a self will
   * be closed, since the default widget is usually one of
   * the dialog buttons.
   * 
   * @param setting True to activate window’s default widget on
   ...
   * 
   * @return True if @a self will activate the default widget.
   */
   ...
   * with the content.
   * 
   * @return True if @a self will propagate the text width.
   */
   ...
   * 
   * @return True if @a self will truncate pasted multi-line text.
   */
...
/** If text is overwritten when typing.
   ...
   * input method. See the Gtk::Settings::property_gtk_im_module()
   * setting.
   *
   * Default value: ""
   *
