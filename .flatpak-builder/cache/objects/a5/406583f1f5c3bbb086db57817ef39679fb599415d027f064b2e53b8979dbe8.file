...
public:
  ...
  /** Looks for a key file named @a file in the paths specified in @a search_dirs,
   * loads the file into @a key_file and returns the file’s full path in @a full_path.
   * 
   ...
   * @param search_dirs <tt>nullptr</tt>-terminated
   * array of directories to search.
   * @param full_path Return location for a string
   * containing the full path of the file, or <tt>nullptr</tt> to ignore.
   * @param flags Flags from Glib::KeyFileFlags.
   * @return True if a key file could be loaded, false otherwise.
   * 
   ...
   * glib_file_set_contents().
   * 
   * If you need stricter guarantees about durability of
   * the written file than are provided by glib_file_set_contents(), use
   * glib_file_set_contents_full() with the return value of
   * Glib::KeyFile::to_data().
   * 
   * This function can fail for any of the reasons that
   * glib_file_set_contents() may fail.
   * 
   * @newin{2,40}
   * 
   ...
   * @return True if @a group_name is a part of @a key_file, false otherwise.
   */
   ...
   * @return True if @a key is a part of @a group_name, false otherwise.
   */
   ...
   * 
   * If calling Glib::KeyFile::get_locale_string() or
   * Glib::KeyFile::get_locale_string_list() with exactly the same @a key_file,
   ...
   * @param group_name A group name.
   * @param key A key.
   * @param locale A locale identifier or <tt>nullptr</tt> to use the current locale.
  ...
  */
   ...
   * 64-bit integer.
   * 
   * This is similar to Glib::KeyFile::get_integer() but can return
   * 64-bit results without truncation.
   * 
   * @newin{2,26}
   * 
   ...
   * Unlike Glib::KeyFile::set_value(), this function handles characters
   ...
   * 
   * If @a locale is `C` then the untranslated value is set (since GLib 2.84).
   * 
   * @newin{2,6}
   * 
   * @param group_name A group name.
   ...
   * \throw Glib::KeyFileError
   * 
   * @param group_name A group name, or <tt>nullptr</tt> to write a top-level comment.
   * @param key A key, or <tt>nullptr</tt> to write a group comment.
   ...
   * \throw Glib::KeyFileError
   * 
   * @param group_name A group name, or <tt>nullptr</tt> to get a top-level comment.
   * @param key A key, or <tt>nullptr</tt> to get a group comment.
   */
