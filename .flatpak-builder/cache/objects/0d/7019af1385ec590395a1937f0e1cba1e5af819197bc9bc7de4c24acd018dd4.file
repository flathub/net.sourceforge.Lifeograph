...
public:
   ...
   * 
   * Adding children with the `Gtk::Box` API is not appropriate, as
   * `Gtk::ShortcutsSection` manages its children internally.
   * 
   * @newin{4,14}
   * 
   * Deprecated: 4.18: This widget will be removed in GTK 5
   * 
   * @param group The `Gtk::ShortcutsGroup` to add.
   */
  void add_group(ShortcutsGroup& group);
