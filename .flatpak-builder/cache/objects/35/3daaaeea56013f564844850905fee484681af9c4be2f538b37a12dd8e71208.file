 ...
 * 
 * If neither `Gtk::TextSearchFlags::VISIBLE_ONLY` nor `Gtk::TextSearchFlags::TEXT_ONLY`
...
/** @ingroup gtkmmEnums */
inline constexpr TextSearchFlags operator|(TextSearchFlags lhs, TextSearchFlags rhs)
...
/** @ingroup gtkmmEnums */
inline constexpr TextSearchFlags operator~(TextSearchFlags flags)
...
public:
   ...
   * Use Gtk::TextBuffer::get_iter_at_offset() to convert
   ...
   * this function returns <tt>true</tt>, has_tag()
  ...
  /** Moves @a iter backward to the previous visible cursor position.
   * 
