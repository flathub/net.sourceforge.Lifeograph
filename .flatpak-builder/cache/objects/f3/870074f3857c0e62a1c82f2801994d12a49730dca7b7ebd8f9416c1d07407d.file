...
public:
   ...
   * 
   * @deprecated Use Gtk::StyleProvider::add_provider_for_display() instead.
   * 
   ...
   * 
   * @deprecated Use Gtk::StyleProvider::remove_provider_for_display() instead.
   * 
   * @param display A `Gdk::Display`.
   * @param provider A `Gtk::StyleProvider`.
   */
   ...
   * 
   * [C example ellipted]
   * Deprecated: 4.10: Use Gtk::Widget::add_css_class() instead
   * 
...
/** @ingroup gtkmmEnums */
inline constexpr StyleContext::PrintFlags operator|(StyleContext::PrintFlags lhs, StyleContext::PrintFlags rhs)
...
/** @ingroup gtkmmEnums */
inline constexpr StyleContext::PrintFlags operator~(StyleContext::PrintFlags flags)
