...
public:
   ...
   * 
   * If @a shrink_center_last is false, start and end widgets keep natural
   ...
   */
  Glib::PropertyProxy< Widget* > property_start_widget() ;
...
/** The widget that is placed at the start position.
   ...
   * or receive notification when the value of the property changes.
   */
  Glib::PropertyProxy_ReadOnly< Widget* > property_start_widget() const;
   ...
   * or receive notification when the value of the property changes.
   */
  Glib::PropertyProxy< Widget* > property_center_widget() ;
...
/** The widget that is placed at the center position.
   ...
   * or receive notification when the value of the property changes.
   */
  Glib::PropertyProxy_ReadOnly< Widget* > property_center_widget() const;
   ...
   * or receive notification when the value of the property changes.
   */
  Glib::PropertyProxy< Widget* > property_end_widget() ;
...
/** The widget that is placed at the end position.
   ...
   * or receive notification when the value of the property changes.
   */
  Glib::PropertyProxy_ReadOnly< Widget* > property_end_widget() const;
