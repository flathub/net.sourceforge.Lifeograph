...
public:
   ...
   * property_use_underline() and
   * property_use_markup() properties to false.
   * 
   * Also see set_markup().
   * 
   * @param str The text to show in @a self.
   */
   ...
   * 
   * If @a str is external data, you may need to escape it
   * with glib_markup_escape_text() or glib_markup_printf_escaped():
   * 
   * 
   * [C example ellipted]
   * 
   * This function sets the property_use_markup() property
   * to true.
   * 
   * Also see set_text().
   * 
   ...
   * new_with_mnemonic()
   * or the property_use_underline() property) the label can
   ...
   * Gtk::Widget::signal_mnemonic_activate() signal on it. The default handler
   ...
   * use Gtk::Widget::set_halign() instead.
   * 
   ...
   * using Gtk::Widget::set_size_request().
   * 
   ...
   * property_natural_wrap_mode() property.
   * 
   ...
   * 
   * The returned @a start and @a end positions are in characters.
   * 
   * @param start Return location for start of selection.
   * @param end Return location for end of selection.
   ...
   * or <tt>nullptr</tt> if standard tabs are used.
   */
   ...
   * set the property_use_underline() property to true in order
...
/** True if the label text will wrap if it gets too wide.
   ...
   * property_wrap() property). The default is [enum@Pango.WrapMode.word],
...
/** Controls how the line wrapping is done.
   ...
   * used, see the property_wrap_mode() property.
   * 
   * The default is [enum@Gtk.NaturalWrapMode.inherit], which inherits
   * the behavior of the property_wrap_mode() property.
   * 
   * @newin{4,6}
   *
...
/** The widget to be activated when the labels mnemonic key is pressed.
   ...
   * the Gtk::NotebookPage::property_tab_expand() child property is set to true.
   * 
...
/** The preferred place to ellipsize the string, if the label does
   ...
   * of how property_width_chars() and property_max_width_chars()
