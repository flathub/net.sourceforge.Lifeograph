...
/** @ingroup gtkmmEnums */
inline constexpr CellRendererState operator|(CellRendererState lhs, CellRendererState rhs)
...
/** @ingroup gtkmmEnums */
inline constexpr CellRendererState operator~(CellRendererState flags)
