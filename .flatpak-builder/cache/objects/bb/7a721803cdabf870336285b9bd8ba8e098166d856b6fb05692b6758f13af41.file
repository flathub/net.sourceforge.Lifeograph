...
public:
   ...
   * equivalent to setting the Gtk::Window::property_application()
   * property of the window to <tt>nullptr</tt>.
   * 
   ...
   * after it has been registered. GIO::Application::startup_vfunc() is
   ...
   * 
   * The @a reason message should be short and to the point.
   * 
   ...
   * @return A non-zero cookie that is used to uniquely identify this, or
   ...
   * @return Accelerators for @a detailed_action_name.
   */
   ...
   * given action.
   * 
   * The first item in @a accels will be the primary accelerator,
   * which may be displayed in the UI.
   * 
   * To remove all accelerators for an action, use an empty,
   * zero-terminated array for @a accels.
   * 
   * For the @a detailed_action_name, see gio_action_parse_detailed_name()
...
/** Set this property to true to register with the session manager.
   ...
   * property_register_session() is set to true.
   * 
   ...
   * 
   * See Gtk::Application::add_window().
   * 
   ...
   * 
   * @param window The window that is being removed.
   */
   ...
   * Gtk::Application::inhibit() with [flags@Gtk.ApplicationInhibitFlags.logout]
...
/** @ingroup gtkmmEnums */
inline constexpr Application::InhibitFlags operator|(Application::InhibitFlags lhs, Application::InhibitFlags rhs)
...
/** @ingroup gtkmmEnums */
inline constexpr Application::InhibitFlags operator~(Application::InhibitFlags flags)
