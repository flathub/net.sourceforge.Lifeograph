...
public:
   ...
   * 
   * Deprecated: 4.10: Use Gtk::FontDialog and Gtk::FontDialogButton
   * instead
   * 
...
/** @ingroup gtkmmEnums */
inline constexpr FontChooser::Level operator|(FontChooser::Level lhs, FontChooser::Level rhs)
...
/** @ingroup gtkmmEnums */
inline constexpr FontChooser::Level operator~(FontChooser::Level flags)
