...
public:
   ...
   * 
   * If <tt>true</tt> is returned the application decides if it wants to draw shadows.
   * If <tt>false</tt> is returned, the compositor decides if it wants to draw shadows.
   * 
   * @newin{4,14}
   * 
   * @return <tt>true</tt> if surfaces can draw shadows or
   * <tt>false</tt> if the display does not support this functionality.
   */
  ...
  /** Adds the given event to the event queue for @a display.
   * 
   ...
   * 
   * @deprecated Using Gdk::Toplevel::set_startup_id() is sufficient.
   * 
   ...
   * @newin{4,14}
   * 
   * @return A `Gdk::DmabufFormats` object.
   */
  ...
  /** <tt>true</tt> if the display supports extensible frames.
   * 
   * @newin{4,14}
   *
   * Default value: <tt>true</tt>
