...
public:
   ...
   * 
   * If property_has_origin() is set to <tt>true</tt> (the default),
   ...
   * for this scale, or <tt>nullptr</tt> if the property_draw_value()
   ...
   * 
   * If the property_draw_value() property is <tt>false</tt>, the return
