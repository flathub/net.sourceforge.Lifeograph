 ...
 * 
 *  @var UnicodeBreakType::AKSARA
 * Aksara (AK). @newin{2,80}
 * 
 *  @var UnicodeBreakType::AKSARA_PRE_BASE
 * Aksara Pre-Base (AP). @newin{2,80}
 * 
 *  @var UnicodeBreakType::AKSARA_START
 * Aksara Start (AS). @newin{2,80}
 * 
 *  @var UnicodeBreakType::VIRAMA_FINAL
 * Virama Final (VF). @newin{2,80}
 * 
 *  @var UnicodeBreakType::VIRAMA
 * Virama (VI). @newin{2,80}
 */
