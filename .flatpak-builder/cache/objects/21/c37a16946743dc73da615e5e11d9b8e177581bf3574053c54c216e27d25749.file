...
public:
   ...
   * appropriate as `Gtk::ShortcutsGroup` manages its children internally.
   * 
   * @newin{4,14}
   * 
   * Deprecated: 4.18: This widget will be removed in GTK 5
   * 
   * @param shortcut The `Gtk::ShortcutsShortcut` to add.
   */
  void add_shortcut(ShortcutsShortcut& shortcut);
