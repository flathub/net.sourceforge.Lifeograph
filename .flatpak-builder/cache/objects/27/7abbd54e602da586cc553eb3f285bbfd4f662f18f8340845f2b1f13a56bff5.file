...
public:
   ...
   * This role is synonymous to @a GTK_ACCESSIBLE_ROLE_PRESENTATION.
   * 
   *  @var Role::NOTE
   * Unused.
   * 
   ...
   * An element that is not represented to accessibility technologies.
   * This role is synonymous to @a GTK_ACCESSIBLE_ROLE_NONE.
   * 
   ...
   * child widget, as is the case for `Gtk::Text` wrappers.
   * 
   * @newin{4,10}
   * 
   ...
   * 
   * This function should be used by `Gtk::Accessible` implementations that
   ...
   * 
   * This function returns <tt>nullptr</tt> for top level widgets.
   * 
   * @newin{4,10}
   * 
   ...
   * for each child, and you want that object to implement the `Gtk::Accessible`
...
template <>
class GTKMM_API Value<Gtk::Accessible::PlatformState> : public Glib::Value_Enum<Gtk::Accessible::PlatformState>
{
public:
  static GType value_type() G_GNUC_CONST;
};
...
template <>
class GTKMM_API Value<Gtk::Accessible::AnnouncementPriority> : public Glib::Value_Enum<Gtk::Accessible::AnnouncementPriority>
{
public:
  static GType value_type() G_GNUC_CONST;
};
