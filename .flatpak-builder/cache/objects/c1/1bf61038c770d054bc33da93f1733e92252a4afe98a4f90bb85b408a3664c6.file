...
public:
  ...
  /** Swaps @a a and @a b in the same level of @a tree_store.
   * 
  ...
  /** Checks if @a iter is an ancestor of @a descendant.
   * 
   * Deprecated: 4.10: Use Gtk::TreeListModel instead
   * 
   * @param iter A valid `Gtk::TreeIter`.
   * @param descendant A valid `Gtk::TreeIter`.
   * @return True if @a iter is an ancestor of @a descendant, and false otherwise.
   */
