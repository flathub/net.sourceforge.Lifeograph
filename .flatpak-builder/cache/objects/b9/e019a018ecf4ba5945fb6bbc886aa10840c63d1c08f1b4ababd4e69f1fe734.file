  ...
  public ConstraintTarget
{
  ...
  /** Destroys the widget. Except: if the widget has a parent, only the C++ wrapper is destroyed, not the C instance;
...
/* QUEUE DRAWS */
   ...
   * 
   * @return The layout manager of @a widget.
   */
   ...
   * any of its children.
   * 
   * Applications should set @a can_focus to false to mark a
   * widget as for pointer/touch use only.
   * 
   * Note that having @a can_focus be true is only one of the
   ...
   * 
   * @param can_focus Whether the input focus can enter
   ...
   * See set_can_focus().
   * 
   * @return True if the input focus can enter @a widget.
   */
  bool get_can_focus() const;
  
  /** Sets whether the widget can own the input focus.
   * 
   * Widget implementations should set @a focusable to true in
   * their init() function if they want to receive keyboard input.
   * 
   * Note that having @a focusable be true is only one of the
   * necessary conditions for being focusable. A widget must
   ...
   * See set_focusable().
   * 
   * @return True if @a widget can own the input focus.
   */
  ...
  /** Causes @a widget to have the keyboard focus for the window
   * that it belongs to.
   * 
   ...
   * 
   * @return True if focus is now inside @a widget.
   */
  bool grab_focus();
   ...
   * 
   * @return True if @a widget can receive pointer events.
   */
   ...
   * within its toplevel.
   * 
   * @return True if @a widget is the current default widget
   * within its toplevel.
   */
   ...
   * 
   * @return True if @a widget acts as the default widget when focused.
   */
   ...
   * 
   * @return The state flags of widget.
   */
   ...
   * 
   * @return True if @a widget is drawable.
   */
  bool is_drawable() const;
  
  /** Determines whether the widget is realized.
   * 
   * @return True if @a widget is realized.
   */
   ...
   * 
   * @param visible Whether @a widget should be mapped along
   * with its parent.
   */
   ...
   * for [enum@Gtk.Orientation.horizontal] or get_height()
   ...
   * keyboard shortcuts.
   * 
   * The @a direction argument indicates what kind of motion is taking
   * place (up, down, left, right, tab forward, tab backward).
   * 
   * This function calls the focus_vfunc() virtual function;
   ...
   * true if moving in @a direction left the focus on a focusable location
   * inside that widget, and false if moving in @a direction moved the focus
   * outside the widget. When returning true, widgets normally call
   * grab_focus() to place the focus accordingly;
   ...
   * child_focus(). When true is returned,
   ...
   * measure() instead of this function.
   * 
  ...
  /** Gets the first ancestor of the widget with type @a widget_type.
   * 
   ...
   * added to a widget hierarchy with a `Gtk::Root` at the top.
   * 
   ...
   * display that @a widget is using.
   * 
   ...
   * for the display that @a widget is using.
   * 
   * Note that this function always works, even when @a widget is not
   * realized yet.
   * 
  ...
  /** Determines whether the widget is a descendent of @a ancestor.
   * 
   * @param ancestor Another `Gtk::Widget`.
   * @return True if @a ancestor contains @a widget as a child,
  ...
  /** Translates coordinates relative to @a src_widget’s allocation
   * to coordinates relative to @a dest_widget’s allocations.
   * 
   * In order to perform this operation, both widget must share
   * a common ancestor. If that is not the case, @a dest_x and @a dest_y
   ...
   * @param src_x X position in widget coordinates of @a src_widget.
   * @param src_y Y position in widget coordinates of @a src_widget.
   * @param dest_x Location to store X position in widget coordinates of @a dest_widget.
   * @param dest_y Location to store Y position in widget coordinates of @a dest_widget.
   * @return True if @a src_widget and @a dest_widget have a common
   ...
   * @return True if @a widget contains the point (x, y).
   */
   ...
   * is assumed to be the top left of @a widget's content area.
   * 
   ...
   * @return The widget's descendant at (x, y).
   */
   ...
   * 
   * The `Pango::Context` will have the appropriate font map,
   ...
   * 
   * The `Pango::Context` will have the appropriate font map, font description,
   ...
   * 
   * The `Pango::Layout` will have the appropriate font map,
...
/* Directionality of Text */
   ...
   * the value set by set_default_direction() will be used.
   * 
   ...
   * 
   * @param label A widget that acts as a mnemonic label for @a widget.
   */
   ...
   * add_mnemonic_label().
   * 
   * @param label A widget that is a mnemonic label for @a widget.
   */
   ...
   * you have to use queue_draw() which invalidates the
   * widget (thus scheduling it to receive a draw on the next frame).
   * queue_draw() will also end up requesting a frame
   ...
   * 
   *  @a markup must contain Pango markup.
   * 
   * This function will take care of setting the
   * property_has_tooltip() as a side effect, and of the
   * default handler for the signal_query_tooltip() signal.
   * 
   ...
   * unnecessary work.
   * 
   * @return True if @a widget is being destroyed.
   */
   ...
   * 
   * @return The widgets style context.
   */
   ...
   * 
   * @param font_map A `Pango::FontMap`.
   */
   ...
   * See set_font_map().
   * 
   * @return The font map of @a widget.
   */
   ...
   * 
   * @return A list model tracking @a widget's children.
   */
   ...
   * because of the slowdowns.
   * 
   * @return A list model tracking @a widget's controllers.
   */
   ...
   * 
   * This function takes care of translating the origin of @a snapshot,
   ...
   * calls to Gtk::Snapshot::translate() or other transform calls
   ...
   * style again.
   * 
   * @param css_class Style class to add to @a widget, without the leading period.
   */
   ...
   * 
   * @param css_class Style class to remove from @a widget, without the leading period.
   */
   ...
   * @return True if @a css_class is currently applied to @a widget.
   */
  ...
  /** Replaces the current style classes of the widget with @a classes.
   * 
   * @param classes <tt>nullptr</tt>-terminated list of style classes.
   */
...
// signals
   ...
   * 
   * @param direction The previous text direction.
   */
   ...
   * is false, or just makes @a widget grab focus if @a group_cycling is true.
   * 
   * @param group_cycling True if there are other widgets with the same mnemonic.
   ...
   * true should be returned, false otherwise. Note that if @a keyboard_tooltip
   * is true, the values of @a x and @a y are undefined and should not be used.
   * 
   ...
   * @param keyboard_tooltip True if the tooltip was triggered using the keyboard.
   * @param tooltip A `Gtk::Tooltip`.
   * @return True if @a tooltip should be shown right now, false otherwise.
   */
...
/** The cursor used by @a widget.
  ...
  /** Enables or disables the emission of the signal_query_tooltip()
   * signal on @a widget.
   * 
   * A true value indicates that @a widget can have a tooltip, in this case
...
protected:
   ...
   * grab_focus() on it.
   * 
   * @param child A direct child widget of @a widget
   * or <tt>nullptr</tt> to unset the focus child.
   */
