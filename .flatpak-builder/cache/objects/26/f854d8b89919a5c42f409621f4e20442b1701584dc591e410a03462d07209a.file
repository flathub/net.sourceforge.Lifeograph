...
public:
  ...
  /** Creates a Glib::DateTime corresponding to the given Unix time @a t in the
   * local time zone.
   * 
   ...
   * @return A new Glib::DateTime, or <tt>nullptr</tt>.
   */
  static DateTime create_from_local_usec(gint64 usecs);
  
  /** Creates a Glib::DateTime corresponding to the given Unix time @a t in UTC.
   * 
   * Unix time is the number of microseconds that have elapsed since 1970-01-01
   * 00:00:00 UTC.
   * 
  ...
  /** Gives the Unix time corresponding to @a datetime, in microseconds.
   * 
   * Unix time is the number of microseconds that have elapsed since 1970-01-01
   * 00:00:00 UTC, regardless of the time zone associated with @a datetime.
   * 
