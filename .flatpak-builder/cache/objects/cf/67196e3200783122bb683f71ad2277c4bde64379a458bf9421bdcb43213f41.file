...
/** When <tt>true</tt>, keyboard navigation and other input-related errors
  ...
  /** When <tt>true</tt>, widgets like switches include shapes to indicate their on/off state.
   * 
   * @newin{4,14}
   *
   * Default value: <tt>false</tt>
...
/** Whether scrolled windows may use overlaid scrolling indicators.
   ...
   * font-related settings (property_gtk_hint_font_metrics(),
   * property_gtk_xft_antialias(), property_gtk_xft_hinting(),
   * property_gtk_xft_hintstyle() and property_gtk_xft_rgba())
   ...
   * @newin{4,16}
   *
   * Default value: Gtk::FontRendering::AUTOMATIC
   *
   * @return A PropertyProxy that allows you to get or set the value of the property,
   * or receive notification when the value of the property changes.
   */
  Glib::PropertyProxy< FontRendering > property_gtk_font_rendering() ;
...
/** How GTK font rendering is set up.
   ...
   * or receive notification when the value of the property changes.
   */
  Glib::PropertyProxy_ReadOnly< FontRendering > property_gtk_font_rendering() const;
