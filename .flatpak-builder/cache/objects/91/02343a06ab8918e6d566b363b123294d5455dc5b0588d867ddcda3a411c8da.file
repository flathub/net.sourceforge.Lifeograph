...
//so we add a m4 conversion to satisfy it:
   ...
   * @return A new dictionary entry type.
   */
  static VariantType create_dict_entry(const VariantType& key, const VariantType& value);

  
  /** Returns the length of the type string corresponding to the given @a type.
   * 
   * This function must be used to determine the valid extent of
   * the memory region returned by Glib::VariantType::peek_string().
   * 
   * @newin{2,24}
   * 
  ...
  /** Returns the type string corresponding to the given @a type.
   * 
   * The result is not nul-terminated; in order to determine its length you
   * must call Glib::VariantType::get_string_length().
   * 
   * To get a nul-terminated string, see Glib::VariantType::dup_string().
   * 
   * @newin{2,24}
   * 
   ...
   * this function on the result of Glib::Variant::get_type() will always
   ...
   * @newin{2,24}
   * 
   * @return True if @a type is definite.
   */
   ...
   * @newin{2,24}
   * 
   * @return True if @a type is a container type.
   */
   ...
   * @newin{2,24}
   * 
   * @return True if @a type is a basic type.
   */
  bool is_basic() const;
  
  /** Determines if the given @a type is a ‘maybe’ type.
   * 
   * This is true if the type string for @a type starts with an `m`.
   * 
   * This function returns true for any indefinite type for which every
   ...
   * @newin{2,24}
   * 
   * @return True if @a type is a ‘maybe’ type.
   */
  bool is_maybe() const;
  
  /** Determines if the given @a type is an array type.
   * 
   * This is true if the type string for @a type starts with an `a`.
   * 
   * This function returns true for any indefinite type for which every
  ...
  /** Determines if the given @a type is a tuple type.
   * 
   * This is true if the type string for @a type starts with a `(` or if @a type is
   ...
   * @newin{2,24}
   * 
   * @return True if @a type is a tuple type.
   */
  bool is_tuple() const;
  
  /** Determines if the given @a type is a dictionary entry type.
   * 
   * This is true if the type string for @a type starts with a `{`.
   * 
   * This function returns true for any indefinite type for which every
   ...
   * @newin{2,24}
   * 
   * @return True if @a type is a dictionary entry type.
   */
   ...
   * @newin{2,24}
   * 
   * @return True if @a type is the variant type.
   */
   ...
   * 
   * This function returns true if @a type is a subtype of @a supertype.  All
   ...
   * @return True if @a type is a subtype of @a supertype.
   */
