...
public:
   ...
   * 
   * @return The unique ID for the window, or `0` if the window
   ...
   * 
   * Deprecated: 4.18: `Gtk::ShortcutsWindow` will be removed in GTK 5
   * 
   * @deprecated 4.18: libadwaita (a C library) has a replacement for GtkShortcutsWindow.
   * 
   * @param help_overlay A shortcuts window.
   */
