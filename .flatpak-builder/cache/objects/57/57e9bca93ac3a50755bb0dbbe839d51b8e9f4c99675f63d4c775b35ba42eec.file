...
public:
   ...
   * <tt>TextBuffer::NotifyFlags operator|(TextBuffer::NotifyFlags, TextBuffer::NotifyFlags)</tt><br>
   * <tt>TextBuffer::NotifyFlags operator&(TextBuffer::NotifyFlags, TextBuffer::NotifyFlags)</tt><br>
   * <tt>TextBuffer::NotifyFlags operator^(TextBuffer::NotifyFlags, TextBuffer::NotifyFlags)</tt><br>
   * <tt>TextBuffer::NotifyFlags operator~(TextBuffer::NotifyFlags)</tt><br>
   * <tt>TextBuffer::NotifyFlags& operator|=(TextBuffer::NotifyFlags&, TextBuffer::NotifyFlags)</tt><br>
   * <tt>TextBuffer::NotifyFlags& operator&=(TextBuffer::NotifyFlags&, TextBuffer::NotifyFlags)</tt><br>
   * <tt>TextBuffer::NotifyFlags& operator^=(TextBuffer::NotifyFlags&, TextBuffer::NotifyFlags)</tt><br>
   */
   ...
   * 
   * @return <tt>true</tt> if there is a redoable action.
   */
   ...
   * 
   * @return <tt>true</tt> if undoing and redoing changes to the buffer is allowed.
   */
...
/** @ingroup gtkmmEnums */
inline constexpr TextBuffer::NotifyFlags operator|(TextBuffer::NotifyFlags lhs, TextBuffer::NotifyFlags rhs)
  { return static_cast<TextBuffer::NotifyFlags>(static_cast<unsigned>(lhs) | static_cast<unsigned>(rhs)); }
...
/** @ingroup gtkmmEnums */
inline constexpr TextBuffer::NotifyFlags operator~(TextBuffer::NotifyFlags flags)
  { return static_cast<TextBuffer::NotifyFlags>(~static_cast<unsigned>(flags)); }

/** @ingroup gtkmmEnums */
inline TextBuffer::NotifyFlags& operator|=(TextBuffer::NotifyFlags& lhs, TextBuffer::NotifyFlags rhs)
  { return (lhs = static_cast<TextBuffer::NotifyFlags>(static_cast<unsigned>(lhs) | static_cast<unsigned>(rhs))); }
...
template <>
class GTKMM_API Value<Gtk::TextBuffer::NotifyFlags> : public Glib::Value_Flags<Gtk::TextBuffer::NotifyFlags>
{
public:
