...
public:
   ...
   */
  bool translate_coordinates(const Glib::RefPtr<const Surface>& to, double& x, double& y) const;
   ...
   * 
   * Compare with get_scale_factor(), which returns the
   * next larger integer.
   * 
