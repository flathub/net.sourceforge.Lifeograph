...
class BytesIcon_Class { public: static Glib::ObjectBase* wrap_new(GObject*); };
...
class Subprocess_Class { public: static Glib::ObjectBase* wrap_new(GObject*); };
class SubprocessLauncher_Class { public: static Glib::ObjectBase* wrap_new(GObject*); };
...
void wrap_init()
{
  ...
  Glib::wrap_register(g_bytes_icon_get_type(), &BytesIcon_Class::wrap_new);
  ...
  Glib::wrap_register(g_subprocess_get_type(), &Subprocess_Class::wrap_new);
  Glib::wrap_register(g_subprocess_launcher_get_type(), &SubprocessLauncher_Class::wrap_new);
  ...
  g_type_ensure(BytesIcon::get_type());
  ...
  g_type_ensure(Subprocess::get_type());
  g_type_ensure(SubprocessLauncher::get_type());
