...
public:
   ...
   * Gio::ListModel::signal_items_changed() signal.
   * 
   ...
   * 
   * @param show_separators Whether to show row separators.
   */
   ...
   * 
   * @param show_separators Whether to show column separators.
   */
   ...
   * 
   * If @a column is unset, the view will be unsorted.
   * 
   ...
   * cells. For that see Gtk::GtkColumnViewColumn::set_factory() and
   * Gtk::GtkColumnViewCell.
   * 
   * @newin{4,12}
   * 
   * @param factory The row factory.
   */
  void set_row_factory(const Glib::RefPtr<ListItemFactory>& factory);
   ...
   * @return The factory.
   */
  Glib::RefPtr<ListItemFactory> get_row_factory();
   ...
   * @return The factory.
   */
  Glib::RefPtr<const ListItemFactory> get_row_factory() const;
  
  /** Sets the factory to use for populating the
   * Gtk::ListHeader objects used in section headers.
   * 
   * If this factory is set to <tt>nullptr</tt>, the list will not show
   * section headers.
   * 
   * @newin{4,12}
   * 
   ...
   * given - and performs the actions specified in @a flags.
   * 
   ...
   * or <tt>nullptr</tt> to not scroll columns.
   ...
   */
  void scroll_to(guint pos, const Glib::RefPtr<ColumnViewColumn>& column =  {}, ListScrollFlags flags =  ListScrollFlags::NONE, const Glib::RefPtr<const ScrollInfo>& scroll =  {});
...
/** Whether columns are reorderable.
   ...
   * or receive notification when the value of the property changes.
   */
  Glib::PropertyProxy< Glib::RefPtr<ListItemFactory> > property_row_factory() ;
...
/** The factory used for configuring rows.
   ...
   * or receive notification when the value of the property changes.
   */
  Glib::PropertyProxy_ReadOnly< Glib::RefPtr<ListItemFactory> > property_row_factory() const;
